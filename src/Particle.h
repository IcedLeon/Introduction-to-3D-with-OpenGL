...
public:
	...
	virtual void InitWindow(vec3 a_vCamPos = vec3(0.0f, 0.0f, 44.0f), vec3 a_vScreenSize = vec3(1024.0f, 780.0f, 0.0f), const char* a_pccWinName = WIN_NAME_PREFIX, bool a_bFullScreen = false);
